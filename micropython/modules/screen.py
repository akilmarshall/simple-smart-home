...
class Screen:
    def __init__(self, width=128, height=64, scl=4, sda=5):
        self.width = width
        self.height = height
    ...
    def write(self, text:str, x:int, y:int, col:int=1):
        '''
        ...
        self.oled.text(text, x, y, col=col)
        self.oled.show()

    def clear(self):
        '''
        write 0 to each pixel
        '''
        self.oled.fill(0)
        self.oled.show()
    ...
    def pixel(self, x, y, i):
        '''
        :x:     x coordinate
        :y:     y coordinate
        :i:     color to write (0 off, 1 on)
        '''
        self.oled.pixel(x, y, i)
        self.oled.show()
