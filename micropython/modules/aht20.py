...
class AHT20:
    """Interface library for AHT20 temperature+humidity sensors"""
    ...
    def relative_humidity(self):
        ...
        self._humidity = (self._buf[1] << 12) | (
            self._buf[2] << 4) | (self._buf[3] >> 4)
    ...
    def temperature(self):
        ...
        self._perform_measurement()
        self._temp = ((self._buf[3] & 0xF) << 16) | (
            self._buf[4] << 8) | self._buf[5]
